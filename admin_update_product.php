...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `products` SET name = '$name',in_stock='$in_stock', details = '$details', price = '$price' WHERE id = '$update_p_id'") or die('query failed');
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="number" class="box" value="<?php echo $fetch_products['in_stock']; ?>" required placeholder="update product Stock" name="in_stock">
